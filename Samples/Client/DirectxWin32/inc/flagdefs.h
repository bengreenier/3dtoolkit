...
DEFINE_string(authCodeUri, "signalingserverauthcodeuri", "The server uri that auth code initiation should connect to.");
DEFINE_string(authPollUri, "signalingserverauthpolluri", "The server uri that auth code polling should connect to.");
